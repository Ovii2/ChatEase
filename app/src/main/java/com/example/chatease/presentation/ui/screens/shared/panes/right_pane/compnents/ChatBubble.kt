...
fun ChatBubble(
    ...
    val isSeenByOtherUser = message.seenBy.any { userId ->
            ...
            Row(
                ...
                if (
                    ...
                    Icon(
                        ...
                        imageVector = if (isSeenByOtherUser) Icons.Outlined.DoneAll else Icons.Outlined.Check,
                        contentDescription = null,
                        tint = if (isSeenByOtherUser) seenCheckColor else MaterialTheme.colorScheme.surface
